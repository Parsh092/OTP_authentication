package com.parsh.authentication_msg91;
...
import com.parsh.authentication_msg91.databinding.ActivityOtpVerifyBinding;
...
public class otpVerifyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verificationId = getIntent().getStringExtra("verification Id");
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            binding.progressBarVerify.setVisibility(View.VISIBLE);
                                            binding.btnVerify.setVisibility(View.INVISIBLE);
                                            Toast.makeText(otpVerifyActivity.this, "Authentication successful", Toast.LENGTH_SHORT).show();
