...
import com.parsh.authentication_msg91.databinding.ActivityOtpBinding;
        ...
        binding.btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (binding.etPhone.getText().toString().trim().isEmpty()) {
                    ...
                    Toast.makeText(OtpActivity.this, "enter the valid number", Toast.LENGTH_SHORT).show();
                } else {
                    otpSend();
                }
            }
    ...
    private void otpSend() {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                Intent intent = new Intent(OtpActivity.this, otpVerifyActivity.class);
